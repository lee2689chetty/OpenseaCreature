                        ...
                        <div class="portlet-body">
                            ...
                            <div class="tab-pane" id="tab_1_2">
                                <div class="row" style="margin-top: 70px;">
                                    <div class="col-md-12">
                                        <table class="table table-striped table-hover" id="tbTransfer">
                                            <thead>
                                            <tr>
...
<script src="<?php echo base_url();?>assets/pages/scripts/admin_transfer_fee_view.js" type="text/javascript"></script>
