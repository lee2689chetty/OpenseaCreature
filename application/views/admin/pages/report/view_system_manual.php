                ...
                <div class="col-sm-12">
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            <div class="row" id="containerSystemManualTrans">
                                <div class="form-horizontal bg-grey">
                                    ...
                                    <div class="col-sm-12 margin-top-10">
                                        ...
                                        <div class="col-sm-12 col-md-2 form-actions">
                                            <button id="btManualTrans" class="btn yellow-gold margin-bottom-10" style="margin-top: 25px;">Generate</button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-striped table-hover" id="tbSystemManual">
                                        <thead>
                                        <tr>
                                            <th> Date </th>
                                            <th> UserName </th>
...
<script src="<?php echo base_url();?>assets/pages/scripts/admin_report_system_manual.js" type="text/javascript"></script>
</body>
</html>