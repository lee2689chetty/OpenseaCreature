                            ...
                            <div class="row" id="containerSystemRevenue">
                                <div class="col-sm-12 margin-top-20">
                                    ...
                                    <div class="col-sm-12 col-md-3 form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control select2" name="baseCurrency" id="baseCurrency" required>
...
<script src="<?php echo base_url();?>assets/pages/scripts/admin_report_system_revenue.js" type="text/javascript"></script>
</body>
