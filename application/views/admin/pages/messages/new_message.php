        ...
        <div class="page-content">
            ...
            <div class="portlet box yellow-gold">
                ...
                <div class="portlet-body">
                    ...
                    <form class="form" method="post" id="formNewMessage" action="<?php echo base_url();?>admin/messages/new_message">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <a href="<?php echo base_url();?>admin/messages/view" class="btn btn-outline yellow-gold">Discard</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="<?php echo base_url();?>assets/pages/scripts/admin_message_new.js" type="text/javascript"></script>
</body>
