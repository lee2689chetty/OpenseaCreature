                ...
                <div class="col-sm-12 col-md-4">
                    <div class="portlet light ">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="<?php echo base_url();?>admin/messages/new_message" class="btn yellow-gold">
                                        ...
                                        <div class="item btn btn-block" data-value="<?php echo $contactItem['thread_id'];?>">
                                            <div class="item-head">
                                                <div class="item-details">
                                                    ...
                                                    <span class="item-label" style=" display: inline-flex; width: 210px;overflow: hidden; text-overflow: ellipsis">
...
<?php echo $footer;?>
<script src="<?php echo base_url();?>assets/pages/scripts/admin_message_view.js" type="text/javascript"></script>
</body>
