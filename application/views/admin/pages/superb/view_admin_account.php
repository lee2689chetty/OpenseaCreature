                ...
                <div class="col-sm-12">
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="<?php echo base_url();?>admin/supers/create" class="btn yellow-gold"> Create new Administrator </a>
                            </div>
                        </div>
                                            ...
                                            <table class="table table-striped table-hover" id="tbContent">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="font-yellow-gold"> Type </th>
                                                ...
                                                <tbody>
                                                    <?php foreach($accountList as $accountListItem){?>
                                                        <tr class="input-large">
                                                            ...
                                                            <td style="padding-top: 15px; padding-bottom: 15px;"> <?php echo $accountListItem['FULL_NAME'];?> </td>
                                                            <td style="padding-top: 15px; padding-bottom: 15px;"> <?php echo $accountListItem['EMAIL'];?> </td>
                                                            <td style="padding-top: 15px; padding-bottom: 15px;"> <?php echo $accountListItem['LEVEL_TITLE'];?> </td>
                                                            <td style="padding-top: 15px; padding-bottom: 15px;"> <?php echo $accountListItem['STATUS_TITLE'];?> </td>
                                                            <td style="padding-top: 15px; padding-bottom: 15px;">
                                                                <a href="<?php echo base_url();?>admin/supers/edit/<?php echo $accountListItem['ID'];?>" class="btn default red-stripe"> Edit Profile </a>
                                                                <a href="<?php echo base_url();?>admin/supers/password/<?php echo $accountListItem['ID'];?>" class="btn default green-stripe"> Change Password </a>
                                                            </td>
                                                        </tr>
                                                    <?php }?>
                                                </tbody>
