                ...
                <div class="col-sm-12">
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="<?php echo base_url();?>admin/file/new_upload/new" class="btn yellow-gold"> Upload New File </a>
                            </div>
                        </div>
                                                    ...
                                                    <tbody>
                                                        <?php foreach($fileList as $fileListItem){?>
                                                            <tr class="input-large">
                                                                <td style="padding-top: 15px; padding-bottom: 15px;"> <a href="<?php echo base_url();?>admin/request/status/<?php echo $fileListItem['TRANS_ID'];?>" class="btn btn-link"><?php echo $fileListItem['TRANS_ID'];?></a>  </td>
                                                                ...
                                                                <td style="padding-top: 15px; padding-bottom: 15px;"> <?php echo date('Y-m-d H:m:s a', $fileListItem['CREATED_AT']);?> </td>
                                                                <td style="padding-top: 15px; padding-bottom: 15px;">
                                                                    <a href="<?php echo base_url();?>file/download_file/<?php echo $fileListItem['ID'];?>" class="btn default green-stripe"> Download </a>
                                                                    <a href="<?php echo base_url().$fileListItem['FILE_PATH'];?>" class="btn default blue-madison-stripe"> View </a>
<!--                                                                    <a href="--><?php //echo base_url();?><!--admin/file/remove_file/--><?php //echo $fileListItem['ID'];?><!--" class="btn default red-stripe"> Delete </a></td>-->
                                                            </tr>
                                                        <?php }?>
                                                    </tbody>
                                                </table>
