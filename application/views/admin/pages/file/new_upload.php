                ...
                <div class="col-sm-12">
                    ...
                    <div class="portlet box yellow-gold">
                        ...
                        <div class="portlet-body">
                            <form id="uploadForm"  enctype="multipart/form-data" role="form" method="post" action="<?php echo base_url();?>admin/file/new_upload<?php if($transId == "") $transId = "new"; echo '/'.$transId;?>">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-7">
                                            <label class="col-sm-12 control-label"> File Owner <span class="font-red">*</span> </label>
                                            <div class="col-sm-12">
                                                <select class="form-control select2" name="accountOwner" id="accountOwner" required>
                                                    <option value="0"> Choose User </option>
                                                    <?php foreach ($userList as $userListItem):?>
                                                        <option value="<?php echo $userListItem['ID'];?>"> <?php echo $userListItem['NAME'];?></option>
                                                    <?php endforeach;?>
                                                </select>
                                            </div>
                                        </div>
