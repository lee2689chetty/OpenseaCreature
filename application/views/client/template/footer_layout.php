...
<script src="<?php echo base_url();?>assets/layouts/scripts/layout.js" type="text/javascript"></script>
<!--<script src="--><?php //echo base_url();?><!--assets/layouts/scripts/demo.js" type="text/javascript"></script>-->
