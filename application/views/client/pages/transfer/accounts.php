            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <?php if($currencypair):?>
                        <div class="alert alert-danger">
                            <button class="close" data-close="alert"></button>
                            <span> Fail to request transfer. Currency pair doesn't exist </span>
                        </div>
                    <?php endif;?>
                    ...
                    <div class="portlet box yellow-gold">
                        ...
                        <div class="portlet-body">
                            ...
                            <form id="formTransfer" action="<?php echo base_url();?>transfer/accounts" method="post" role="form" class="form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="bs-select form-control required" name="fromAccount"  data-show-subtext="true">
                                                        ...
                                                        <?php foreach ($senderAccounts as $accountItem){
                                                            echo ("<option value=\"".$accountItem['ID']."\" data-content=\""
                                                                    .$accountItem['ACCOUNT_NUMBER']." <span class='label label-sm label-success'> ".$accountItem['CURRENCY_TITLE']. "  ".$accountItem['AVAILABLE_AMOUNT']." </span>\"> </option>");
                                                            }
                                                        ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select required class="bs-select form-control" name="toAccount">
                                                        <option value="0"> Select Account </option>
                                                        <?php foreach ($receiverAccounts as $accountItem){
                                                            echo ("<option value=\"".$accountItem['ID']."\" data-content=\""
...
<script src="<?php echo base_url();?>assets/pages/scripts/client_transfer_between_accounts.js" type="text/javascript"></script>
